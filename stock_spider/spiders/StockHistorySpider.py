...
class HistoryItemSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for line in stock_id_list[:2]:
            stock_code = '1' + line[2:]
            stock_urls.append("http://quotes.money.163.com/service/chddata.html?code={}&start={}&end={}&fields=TCLOSE;HIGH;LOW;TOPEN;LCLOSE;CHG;PCHG;TURNOVER;VOTURNOVER;VATURNOVER;TCAP;MCAP"
